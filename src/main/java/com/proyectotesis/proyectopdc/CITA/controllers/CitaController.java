...
public class CitaController {
    ...
    public void registrarPaciente(@RequestBody Cita cita){citaDao.registrarCita(cita);}
    @RequestMapping(value = "api/citas/{id}",method = RequestMethod.DELETE)
    public void eliminarPaciente(@PathVariable int id){citaDao.eliminarCita(id);}
